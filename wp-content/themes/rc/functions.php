 ...
 */
function rc_scripts() {
	wp_enqueue_style( 'rc-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'rc-style', 'rtl', 'replace' );

	wp_enqueue_script( 'rc-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
