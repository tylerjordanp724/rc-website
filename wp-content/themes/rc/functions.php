...
function red_camel_vehicle() {
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'revisions', 'custom-fields', 'thumbnail', 'page-attributes', 'post-formats' ),
...
function red_camel_testimonial() {
	...
	$args = array(
		...
		'description'           => __( 'All Testimonials for Red Camel Auto', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'revisions', 'custom-fields', 'thumbnail', 'page-attributes', 'post-formats' ),
		'hierarchical'          => true,
		'public'                => true,
	...
	register_post_type( 'rc_testimonial', $args );

}
add_action( 'init', 'red_camel_testimonial', 0 );
